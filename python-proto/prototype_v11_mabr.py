...
def main() -> None:
    ...
    # The mold extends its total length to accommodate the muzzle cut.
    effective_total_length = args.total_length + muzzle_extension
    ...
    if cached is not None:
        ...
        # We want the mold to END at (logical_muzzle_vox + pad).
