...
def apply(cavity_bin, origin, pitch, *, state, insertion_vox, context, console):
    ...
    # 3. Bounding Box in World Space (for optimization)
    ...
    # Point relative to which the box is defined
    anchor_world = p0 + R_total @ np.array([ox, oy, 0.0])
    ...
    for i in range(i0, i1 + 1):
        ...
        for j in range(j0, j1 + 1):
            ...
            for k in range(k0, k1 + 1):
                ...
                # Local space origin is the center of the box
