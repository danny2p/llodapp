...
const feature: FeatureDef = {
  id: "slide_circles",
  label: "Slide Circles",
  description: "Set of 3 nested cylinders for slide relief or mounting points.",
  color: "#38bdf8", // Sky blue for additive features
  published: true,
  ...
  params: [
    ...
    { id: "spacing",   type: "number", label: "Spacing",        unit: "mm", default: 30, min: 5,   max: 100, step: 1,   hint: "Center-to-center distance" },
