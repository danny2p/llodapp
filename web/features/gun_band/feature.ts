...
const feature: FeatureDef = {
  ...
  params: [
    ...
    { id: "depthZ",       type: "number", label: "Depth Z",       code: "D",  unit: "mm", default: 10, min: 1,   max: 40, step: 0.5, hint: "Z-height of the band extrusion." },
    { id: "extendTop",    type: "number", label: "Extend Top",    code: "ET", unit: "mm", default: 0,  min: 0,   max: 50, step: 0.5, hint: "Extend the band past the Band Top point (p0) along the edge direction." },
    ...
    { id: "chamfer",      type: "number", label: "Chamfer",       code: "c",  unit: "mm", default: 1,  min: 0,   max: 15, step: 0.5, hint: "45° ramp on the two short ends (top and bottom caps)." },
  ],
  Overlay,
};
