...
const feature: FeatureDef = {
  ...
  params: [
    ...
    { id: "offsetY",   type: "number", label: "Offset Y",   unit: "mm",  default: 0,   min: -50, max: 50,  step: 0.5, hint: "Nudge from slide top. 0 = top edge of channel sits on the gun's top Y (auto-anchored per scan)." },
